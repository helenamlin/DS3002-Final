...
"""
                   words = ["sad", "tired", "exhausted", "mad","angry", "disgusted", "depressed", "disappoint", "empty", "helpless", "anxious", "hopeless", "lonely", "lost", "miserable", "die", "worthless"]
                   elif inp.lower() in words:
"""          
